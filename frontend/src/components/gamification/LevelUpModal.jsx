...
// --- THIS IS THE FIX ---
// We import it directly from 'react-use' instead of the deep path
import { useWindowSize } from 'react-use'; 

const LevelUpModal = () => {
    const { showLevelUpModal, level, lastReward, closeLevelUpModal } = useGamification();
    ...
    return (
        ...
        >
            ...
            >
                ...
                <p className="text-white text-2xl mb-4">You've reached Level {level}!</p>
                <p className="text-accent-cyan text-lg font-semibold mb-6">{lastReward}</p>
                <button
                    onClick={closeLevelUpModal}
