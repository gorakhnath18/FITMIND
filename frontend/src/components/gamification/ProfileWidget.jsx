...
// The level thresholds are needed to calculate the XP bar's percentage accurately.
const LEVEL_THRESHOLDS = { 1: 0, 2: 200, 3: 500, 4: 1000, 5: 1800, 6: 3000 };

// This is the sub-component for the XP Bar
const XPBar = ({ currentXp, startXp, endXp, theme }) => {
  ...
  // The barColor and shadowColor are now conditional based on the theme.
